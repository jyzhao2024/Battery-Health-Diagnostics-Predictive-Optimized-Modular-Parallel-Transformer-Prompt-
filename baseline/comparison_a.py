...
def plot_comparison(true_vals_dicts, transfer_vals_dicts, battery_names, max_cycle_life, model_names, interval=45,
...
def main():
    ...
    selected_batteries = ['a5', 'a6', 'a7', 'a9', 'a11', 'a14']
    ...
    plot_comparison(true_vals_dicts, transfer_vals_dicts, selected_batteries, max_cycle_life, model_names, interval=45)
