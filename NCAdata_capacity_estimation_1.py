...
test_1 = ['SNL_18650_NCA_15C_0-100_0.5-1C_a', 'SNL_18650_NCA_15C_0-100_0.5-1C_b', 'SNL_18650_NCA_15C_0-100_0.5-2C_b', 'SNL_18650_NCA_25C_0-100_0.5-0.5C_a',
          'SNL_18650_NCA_25C_0-100_0.5-1C_a', 'SNL_18650_NCA_25C_0-100_0.5-1C_b', 'SNL_18650_NCA_25C_0-100_0.5-1C_c', 'SNL_18650_NCA_25C_0-100_0.5-1C_d']
channel_1 = ['15#1', '15#2', '15#3', '25#1', '25#2','25#3', '25#4', '25#5']
...
ax.plot([2.35, 3.0], [2.35, 3.0], 'k--', label='y = x', linewidth=2)

ax.set_xlim(2.35, 3.0)
...
colors = ['#2F4D92', '#C19796', '#C5B2CF', '#3E6534', '#81B333', '#E59646', '#47B9E5', '#BB232C']
