...
test_1 = ['CY25-05_1-#8', 'CY25-05_1-#9', 'CY35-05_1-#1', 'CY25-05_1-#13', 'CY25-05_1-#15', 'CY25-05_1-#17', 'CY25-05_1-#19', 'CY25-05_1-#2', 'CY25-05_1-#20','CY25-05_1-#21']
channel_1 = ['25#8', '25#9', '35#1', '25#13', '25#15','25#17', '25#19', '25#2', '25#20','25#21']
...
colors = ['#1F4E79', '#00A3A4', '#E67E00', '#5E2A84', '#7C9A2F', '#9E2A2F', '#557B8A', '#B29DCE', '#16A085', '#F1C40F']
...
for i, name in enumerate(test_1):
    ...
    error = error[(error >= -0.03) & (error <= 0.03)]
